...
# Feet get priority 1 so their (randomized) friction decides foot-ground
# contact instead of MuJoCo taking the max of the foot and terrain values.
_FOOT_PRIORITY = {FOOT_COLLISION_REGEX: 1, ".*": 0}
