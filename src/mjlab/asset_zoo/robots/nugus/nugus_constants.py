...
STAND_STRAIGHTER_KEYFRAME = EntityCfg.InitialStateCfg(
  pos=(0, 0, 0.49500),
  # Symmetrized 2026-07-17 (doc 15 R46): the original values were captured
  # from live encoders and carried 1-5 mrad left-right asymmetry — a
  # constant-direction chirality seed at every reset. Each pair is the
  # average of the originals under the joint mirror signs; real per-servo
  # offsets are modeled by encoder-bias DR, not the keyframe.
  joint_pos={
    "right_shoulder_pitch": 1.715,
    "left_shoulder_pitch": 1.715,
    "right_shoulder_roll": -0.198,
    "left_shoulder_roll": 0.198,
    "right_elbow_pitch": -0.7175,
    "left_elbow_pitch": -0.7175,
    "right_hip_yaw": -0.0335,
    "left_hip_yaw": 0.0335,
    "right_hip_roll": -0.1625,
    "left_hip_roll": 0.1625,
    ...
    "right_ankle_roll": 0.1675,
    "left_ankle_roll": -0.1675,
    "neck_yaw": 0.0,
    "head_pitch": 0.0,
  },
  joint_vel={".*": 0.0},
...
STAND_BENT_KNEES_KEYFRAME = EntityCfg.InitialStateCfg(
  pos=(0, 0, 0.473774),
  # Symmetrized 2026-07-17 (doc 15 R46) — see STAND_STRAIGHTER note.
  joint_pos={
    "right_shoulder_pitch": 1.71,
    "left_shoulder_pitch": 1.71,
    "right_shoulder_roll": -0.197,
    "left_shoulder_roll": 0.197,
    "right_elbow_pitch": -0.7155,
    "left_elbow_pitch": -0.7155,
    "right_hip_yaw": -0.0334,
    "left_hip_yaw": 0.0334,
    "right_hip_roll": -0.1625,
    "left_hip_roll": 0.1625,
    ...
    "right_ankle_pitch": -0.509,
    "left_ankle_pitch": -0.509,
    "right_ankle_roll": 0.1665,
    "left_ankle_roll": -0.1665,
    "neck_yaw": 0.0,
    "head_pitch": 0.0,
  },
  joint_vel={".*": 0.0},
