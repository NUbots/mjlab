...
from mjlab.tasks.arm_tracking.config.nugus.env_cfgs import (
  nubots_nugus_arm_tracking_env_cfg,
)
...
def build_env() -> ManagerBasedRlEnv:
  cfg = nubots_nugus_arm_tracking_env_cfg(play=True)
...
def main() -> None:
  env = build_env()
  print("Running Nugus Arm Track Sanity Checks")
  try:
    dump_physics(env)
